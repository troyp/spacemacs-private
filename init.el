...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (zenburn-theme yapfify yaml-mode xterm-color wid-edit+ wgrep-pt wgrep-helm wgrep-ag wgrep-ack wgrep web-mode web-beautify vimrc-mode vala-snippets vala-mode utop ucs-cmds tuareg top-mode toml-mode tiny thumb-frm thrift thingatpt+ tagedit strings stan-mode soothe-theme solarized-theme smex smeargle slim-mode shell-pop scss-mode scad-mode sayid sass-mode rvm ruby-tools ruby-test-mode ruby-refactor rubocop rspec-mode robe replace+ realgud test-simple loc-changes load-relative rbenv ranger rake racket-mode racer qml-mode pyvenv pytest pyenv-mode py-isort pug-mode plsense-direx plsense yaxception pkgbuild-mode pip-requirements phpunit phpcbf php-extras php-auto-yasnippets pdf-tools tablist pde paradox palette ox-gfm orgit org-projectile org-category-capture org-present org-pomodoro log4e gntp org-download org-brain ocp-indent nlinum-relative nlinum nim-mode flycheck-nimsuggest nameless naked multi-term mozc move-dup monokai-theme moe-theme mmm-mode minitest merlin meghanada matlab-mode markdown-toc markdown-mode magit-gitflow magit magit-popup ghub ls logcat livid-mode skewer-mode live-py-mode less-css-mode lacarte kivy-mode json-mode json-snatcher json-reformat jsfmt js2-refactor js2-mode js-doc jedi-direx jedi jedi-core python-environment ivy-purpose ivy isearch-prop isearch+ intero insert-shebang impatient-mode hy-mode htmlize hoon-mode hlint-refactor hindent help-mode+ help+ helm-w3m w3m helm-pydoc helm-hoogle helm-gitignore helm-firefox helm-dired-history helm-css-scss helm-company helm-c-yasnippet haskell-snippets haml-mode graphviz-dot-mode gradle-mode goto-gem google-this godoctor go-rename go-guru go-eldoc gnuplot gitignore-mode gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link git-commit gh-md general geiser fuzzy frame-cmds font-lock+ fn flycheck-rust flycheck-pos-tip pos-tip flycheck-package package-lint flycheck-haskell inf-ruby rust-mode inflections multiple-cursors paredit spinner queue peg levenshtein pythonic ghc go-mode lua-mode xcscope tern web-completion-data haskell-mode windata tree-mode hexrgb frame-fns php-mode simple-httpd web noflet kv yasnippet sbt-mode scala-mode julia-mode let-alist with-editor names vimish-fold moz ws-butler winum which-key volatile-highlights vi-tilde-fringe uuidgen use-package toc-org symon string-inflection spaceline restart-emacs request rainbow-delimiters persp-mode pcre2el password-generator org-bullets open-junk-file neotree move-text macrostep lorem-ipsum linum-relative link-hint info+ indent-guide hungry-delete hl-todo highlight-parentheses highlight-numbers highlight-indentation hide-comnt help-fns+ helm-themes helm-swoop helm-purpose helm-projectile helm-mode-manager helm-make helm-flx helm-descbinds helm-ag google-translate golden-ratio flycheck-bashate flx-ido fish-mode firefox-controller fill-column-indicator fancy-battery faceup facemenu+ eyebrowse expand-region exec-path-from-shell evil-visualstar evil-visual-replace evil-visual-mark-mode evil-vimish-fold evil-unimpaired evil-tutor evil-textobj-column evil-surround evil-search-highlight-persist evil-org evil-numbers evil-nerd-commenter evil-mc evil-matchit evil-magit evil-lisp-state evil-lion evil-indent-plus evil-iedit-state evil-exchange evil-escape evil-ediff evil-args evil-anzu evil-adjust ess-R-data-view eshell-z eshell-prompt-extras esh-help epc ensime engine-mode emmet-mode elnode elmacro elisp-slime-nav elfeed-web elfeed-org elfeed-goodies editorconfig ebuild-mode dumb-jump drupal-mode doremi-mac doremi-frm doremi-cmd disaster dirtree direx-grep dired-toggle-sudo dired-sort-menu+ dired-rainbow dired-icon dired-du dired-collapse dired+ diminish diff-hl deft define-word dante dactyl-mode cython-mode csv-mode company-web company-tern company-statistics company-shell company-php company-lua company-go company-ghci company-ghc company-emacs-eclim company-cabal company-c-headers company-anaconda commenter column-enforce-mode color-theme-sanityinc-tomorrow coffee-mode cmm-mode cmake-mode cmake-ide clojure-snippets clj-refactor clean-aindent-mode clang-format cl-lib-highlight cider-eval-sexp-fu chruby cargo caml bundler autofit-frame auto-yasnippet auto-highlight-symbol auto-compile arduino-mode alert alect-themes aggressive-indent afternoon-theme adaptive-wrap ace-window ace-link ace-jump-helm-line ac-ispell))))
(custom-set-faces
